...
export const SERVICES_CONFIG: Record<ServiceType, { price: string; description: string; icon: React.ReactNode }> = {
  ...
  'Payroll Services': {
    price: 'Monthly + onboarding',
    icon: <Users className="w-5 h-5" />,
    description: 'Ongoing payroll processing and compliance support (W-2 employees + 1099 contractors), including onboarding and year-to-date cleanup when needed.'
  },
  'State Tax Forms': { 
    price: 'Varies', 
